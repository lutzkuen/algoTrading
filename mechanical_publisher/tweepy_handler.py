...
if __name__ == '__main__':
    ...
    for major in majors:
        ...
        if close < 0:
            ...
            sent = 'bullish'
        twitter_text = 'Daily Forecast ' + major + ' High: ' + str(shorten(high)) + ' / Low: ' + str(shorten(low)) + ' Sentiment ' + sent + ' (' + str(round(100*abs(close),2)) + ' %)  - powered by themechnicalgerman.com #forex #' + major.replace('_','')
        print(twitter_text)
